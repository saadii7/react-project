                ...
                <div className="form-group">
                    ...
                    <div>
                        <TextField
                            ...
                            variant="outlined"
                        >
                            {this.props.sports.map((sport) => <option key={sport._id} value={sport._id}>
                                {sport.sportName}
                            </option>)}
                        </TextField>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles, { withTheme: true })(withRouter(Event)));